...
import { Smile, Meh, Frown, Heart, Zap, Coffee, LucideIcon } from 'lucide-react';
...
export default function Home() {
  ...
  const moods: Mood[] = [
    { id: 'amazing', icon: Heart, label: 'Amazing', color: 'bg-pink-500', emoji: '💖' },
    { id: 'energized', icon: Zap, label: 'Energized', color: 'bg-yellow-500', emoji: '⚡' },
    { id: 'chill', icon: Coffee, label: 'Chill', color: 'bg-blue-500', emoji: '☕' },
    { id: 'happy', icon: Smile, label: 'Happy', color: 'bg-green-500', emoji: '😊' },
    { id: 'meh', icon: Meh, label: 'Meh', color: 'bg-gray-500', emoji: '😐' },
    { id: 'down', icon: Frown, label: 'Down', color: 'bg-purple-500', emoji: '😔' },
  ];
